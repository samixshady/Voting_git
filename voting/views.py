...
def generate_ballot(display_controls=False):
    ...
    for position in positions:
        ...
        instruction = "No candidates available for this position"
            ...
            <div class="col-xs-12">
                <div class="box box-solid" id="{position.id}">
                    <div class="box-header with-border">
                        ...
                        {f'<div class="pull-right box-tools"><button type="button" class="btn btn-default btn-sm moveup" data-id="{position.id}" {up}><i class="fa fa-arrow-up"></i></button><button type="button" class="btn btn-default btn-sm movedown" data-id="{position.id}" {down}><i class="fa fa-arrow-down"></i></button></div>' if display_controls else ''}
                    </div>
                    <div class="box-body">
                        <p>{instruction}
...
def show_ballot(request):
    ...
    context = {
        'ballot': ballot,
        'user': decrypted_user,  # Pass decrypted user details to the template
    }
